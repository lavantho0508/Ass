    ...
    <div class="row">
            ...
            <div class="card mb-4 mb-xl-0">
                ...
                <div class="card-body text-center">
                    ...
                    <c:when test="${!empty username.avarta }">
                      <img class="img-account-profile rounded-circle mb-2" src="/Assigment/files/${username.avarta}" alt="" width="60%">
                    </c:when>
                    <c:when test="${!empty photo}">
                    <img class="img-account-profile rounded-circle mb-2" src="/Assigment/files/${photo}" alt="" width="60%">
                    </c:when>
                    </c:choose>
        ...
        <div class="col-xl-8">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="/Assigment/user/profile?id=${username.id}" method="post" enctype="multipart/form-data" >
                        <div class="mb-3">
