...
<body>
                ...
                <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/Assigment/admin/index/category/home">Home</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/Assigment/admin/index/category/create">Thêm mới</a>
                      </li>
	...
	<div class="modal fade" id="edit" data-bs-backdrop="static"
		...
		<form action="/Assigment/admin/index/category/update" method="get" class="edit-modal">
	...
	$(document).ready(function (){
		$(document).on("click",".delete",function(){
			 ...
			 if(que){
				 document.location='/Assigment/admin/index/category/delete?id='+$id;
			 }
		})
	})
	</script>
