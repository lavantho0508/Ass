...
<body>
		...
		<header>
			...
			<div class="row">
				...
				<div class="col-2">
					...
					<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<li><a class="dropdown-item" href="/Assigment/user/profile?id=${username.id}">Thông tin tài khoản</a></li>
                        <li><a class="dropdown-item" href="/Assigment/admin/index/category/home">Quản lý thể loại</a></li>
                        <li><a class="dropdown-item" href="/Assigment/admin/index/product/home">Quản lý Sản phẩm</a></li>
						<li><hr class="dropdown-divider"></li>
						<li><a class="dropdown-item" href="/Assigment/user/logout">Đăng
								xuất</a></li>
					</ul>
			...
			<div class="tab-content" id="myTabContent">
						...
						<tbody>
							<c:forEach items="${user}" var="item">
								<tr>
									...
									<th><a href="/Assigment/user/delete?id=${item.id}"
				...
				<div class="tab-pane fade" id="profile" role="tabpanel"
					...
					<form action="/Assigment/admin/index" method="post">
						<div class="card">
				...
				<div class="tab-pane fade" id="donhang" role="tabpanel"
					aria-labelledby="donhang-tab">hello</div>
			</div>
	...
	<div class="modal fade" id="edit" data-bs-backdrop="static"
		...
		<form action="/Assigment/admin/update" method="get">
