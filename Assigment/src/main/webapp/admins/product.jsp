...
<body>
	<div class="container">
                ...
                <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/Assigment/admin/index/product/home">Home</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/Assigment/admin/index/product/create">Thêm mới</a>
                      </li>
				...
				<tbody>
					<c:forEach items="${list}" var="item">
						<tr>
							...
							<td class="images">
							<img src="/Assigment/files/${item.images}" alt="Loading ..." width="100px">
							</td>
							<td><a href="/Assigment/admin/index/product/delete?id=${item.id}" class="btn btn-danger">Xóa</a>
	 ...
	 <div class="modal fade" id="edit" data-bs-backdrop="static"
		...
		<form action="/Assigment/admin/index/product/update" method="post" class="edit-modal" enctype="multipart/form-data">
