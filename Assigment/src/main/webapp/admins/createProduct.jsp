...
<body>
	<div class="container">
                ...
                <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/admin/index/product/create">Thêm mới</a>
                      </li>
		...
		<article>
			<form action="/Assigment/admin/index/product/create" method="post" enctype="multipart/form-data">
